...
export default function InteractiveBackground() {
  ...
  useEffect(() => {
    // Disable physics ribbon completely on mobile to save battery and boost framerate
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-0 overflow-hidden bg-[#110f0e] pointer-events-none">
        {/* Simple static background fallback for mobile to save battery */}
        ...
        <canvas ref={canvasRef} className="absolute inset-0 z-10 opacity-100 pointer-events-none hidden md:block" />
